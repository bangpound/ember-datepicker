...
export default Em.TextField.extend({
  ...
  date: null,
  yearRange: Em.computed('yearRange', function() {
  ...
  _yearRange: Em.computed('yearRange', function() {
   ...
   */
  setDate: Em.observer('date', function() {
    var d = null;
   ...
   * the initial `didInsertElement`.
   */
  setMinDate: Em.observer('minDate', function() {
   ...
   * the initial `didInsertElement`.
   */
  setMaxDate: Em.observer('maxDate', function() {
